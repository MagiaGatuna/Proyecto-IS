...
setIconImage(new ImageIcon("res/logoSistemaComedor.png").getImage());
  ...
  boton_tarifas = Diseño_interfaz.Creador_Botones("TARIFAS", anchoP - 680, 35, 180, 45, Diseño_interfaz.colorazul);
  BotonUtil.darEstiloBoton(boton_cerrarsesion, 170, 40);
  BotonUtil.darEstiloBoton(boton_editar_estado, 170, 40);
  BotonUtil.darEstiloBoton(boton_tarifas, 170, 40);
  ...
  barraSuperior.add(boton_tarifas);
// Sección Menú
...
public JButton getBtnTarifas(){
  return boton_tarifas;
}
