...
public Landingpage(){
//declaracion del panel y calculos de tamaño y color
setLayout(null);
...
//Llamada a los metodos para implementar las tres secciones principales de la interfaz
...
private void mediopantalla(int pantalla){
...
private void barrainferior(int alto, int pantalla){
